...
declare class MyProjectCharacter extends Character { 
	TopDownCameraComponent: CameraComponent;
	CameraBoom: SpringArmComponent;
	CursorToWorld: DecalComponent;
	static GetDefaultObject(): MyProjectCharacter;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): MyProjectCharacter;
	static C(Other: UObject | any): MyProjectCharacter;
}

declare class MyProjectGameMode extends GameModeBase { 
	static GetDefaultObject(): MyProjectGameMode;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): MyProjectGameMode;
	static C(Other: UObject | any): MyProjectGameMode;
}

declare class MyProjectPlayerController extends PlayerController { 
	static GetDefaultObject(): MyProjectPlayerController;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): MyProjectPlayerController;
	static C(Other: UObject | any): MyProjectPlayerController;
}
...
declare class LandscapeEditorObject extends UObject { 
	...
	ImportLandscape_HeightmapImportResult: ImportLandscape_HeightmapImportResult;
	...
	ImportLandscape_AlphamapType: ImportLandscape_AlphamapType;
	...
	PaintingRestriction: PaintingRestriction;
